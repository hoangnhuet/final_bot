...
from final_env import GazeboEnv
...
file_name = "Policy"  # name of the file to store the policy
...
env = GazeboEnv(launch_file, 24, package) # 24 is the number of velodyne data, NOT the state dim, state dim = 24 + 4 
time.sleep(5)
